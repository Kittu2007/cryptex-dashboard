...
export default function RightPanel() {
  ...
  useEffect(() => {
    gsap.from(panelRef.current, {
      x: 20, opacity: 0, duration: 0.6, ease: "expo.out", delay: 0.6
    });
    ...
    <div ref={panelRef} className="right-panel" style={{
      ...
      <div style={{ marginTop: 20 }}>
        ...
        <span style={{
          ...
          +${portfolio.totalGain.toLocaleString()} (+{portfolio.totalGainPct}%)
        </span>
        ...
        {portfolio.holdings.map((h, i) => (
          <div key={i} style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontFamily: "var(--font-ui)", fontSize: 11, color: "var(--text-2)" }}>
                {h.symbol}
              </span>
            </div>
